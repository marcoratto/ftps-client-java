...
public class RelativePath {
	...
	private static Logger logger = Logger.getLogger(RelativePath.class);
...
make sense
	...
	public static String getRelativePath(File home, File f) {
		...
		logger.debug("homelist has " + homelist.size() + " items");
		logger.debug("filelist has " + filelist.size() + " items");
		
		if (homelist.size() == filelist.size()) {
			return "";
		}
