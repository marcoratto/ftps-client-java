...
public class FTPSListenerLog4J extends FTPSListenerAbstract {
	
	private static Logger logger = Logger.getLogger(FTPSListenerLog4J.class);
	...
	public void onStartUploadFTPS(int counter, int totalFiles, File fromUri, String toUri) throws FTPSListenerException{
		logger.info("Start upload file " + counter + "/" + totalFiles + " from " + fromUri + " to " + toUri);
	}
	
	public void onEndUploadFTPS(int counter, int totalFiles, File fromUri, String toUri) throws FTPSListenerException{
		logger.info("End upload file " + counter + "/" + totalFiles + " from " + fromUri + " to " + toUri);
	}
